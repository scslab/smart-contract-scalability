...
GroundhogVirtualMachine::propose_tx_block(AssemblyLimits& limits, uint64_t max_time_ms, uint32_t n_threads, Block& block_out)
{
    ...
    StaticAssemblyWorkerCache<GroundhogGlobalContext, GroundhogBlockContext>::start_assembly_threads(mempool, global_context, *current_block_context, limits, engine, n_threads);
    ...
    StaticAssemblyWorkerCache<GroundhogGlobalContext, GroundhogBlockContext>::wait_for_stop_assembly_threads();
